...
$parcel$export(
  module.exports,
  'Avatar',
  () => $e00a23217c74ccb9$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'AvatarList',
  () => $aae2cdbdcba990b9$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'Badge',
  () => $e1218bb755e43134$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'Button',
  () => $24cf76bc329384dd$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'Container',
  () => $f32c7848c29308c0$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'ContentCard',
  () => $6563f807c4cd184b$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'Input',
  () => $2480fd5c982ae396$exports.default
);
$parcel$export(
  module.exports,
  'ContentCardList',
  () => $2cd3fd31530cc318$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'LoanCard',
  () => $d9b0acdb1f0cb83d$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'Title',
  () => $184cd3bea746e74f$export$2e2bcd8739ae039
);
$parcel$export(
  module.exports,
  'VSpace',
  () => $73eaeef512cc934c$export$2e2bcd8739ae039
);

function $1dfa65d911dbcc46$var$Avatar({
  avatarUrl: avatarUrl,
  hasBorder: hasBorder,
  ...rest
}) {
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('img', {
    ...
    className: $parcel$interopDefault($81XA9$classnames)(
      'ud-h-10 ud-w-10 ud-object-cover ud-rounded-full',
      {
...
function $cf674ce9945ad554$var$AvatarList({
  users: users,
  label: label,
  onClick: onClick,
}) {
    ...
    children: [
      /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('div', {
        ...
        children: users.slice(0, 3).map((user, index) =>
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
            $1dfa65d911dbcc46$export$2e2bcd8739ae039,
            {
...
function $ad281e573d8937c4$var$Badge({
  ...
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('span', {
    ...
    className: $parcel$interopDefault($81XA9$classnames)(
      'ud-rounded-full ',
      $ad281e573d8937c4$var$VARIANT[variant],
      $ad281e573d8937c4$var$SIZE[size]
    ),
    ...rest,
    __source: {
...
function $3415cc989545fa06$var$Button({
  variant: variant = 'primary',
  size: size = 'base',
  children: children,
  className: className,
  ...
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('button', {
    ...
    className: $parcel$interopDefault($81XA9$classnames)(
      ...
      $3415cc989545fa06$var$BUTTON_VARIANT[variant],
      $3415cc989545fa06$var$BUTTON_SIZE[size],
      className,
      {
...
function $6844af41886a83f1$var$ContentCard({
  avatarUrl: avatarUrl,
  coverUrl: coverUrl,
  title: title,
  shortDesc: shortDesc,
  ...
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('article', {
    className:
      'ud-flex ud-flex-col ud-rounded-lg ud-w-64 ud-bg-white ud-shadow-md ud-group hover:ud-bg-warning ud-cursor-pointer ud-overflow-hidden',
    onClick: onClick,
    __source: {
    ...
    children: [
      /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('div', {
        ...
        children: [
          ...
          coverUrl
            ? /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('img', {
          ...
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('div', {
            ...
            __self: this,
            children: /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
              $1dfa65d911dbcc46$export$2e2bcd8739ae039,
              {
                avatarUrl: avatarUrl,
                __source: {
      ...
      /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('div', {
        ...
        children: [
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('h2', {
            className:
              'ud-text-black ud-font-semibold group-hover:ud-text-primary',
            __source: {
              fileName: 'src/components/ContentCard.js',
              lineNumber: 24,
              columnNumber: 9,
...
var $6844af41886a83f1$export$2e2bcd8739ae039 =
  $6844af41886a83f1$var$ContentCard;

var $2480fd5c982ae396$exports = {};

$parcel$export(
  $2480fd5c982ae396$exports,
  'default',
  () => $2480fd5c982ae396$export$2e2bcd8739ae039,
  (v) => ($2480fd5c982ae396$export$2e2bcd8739ae039 = v)
);
...
const $34a654368e265f37$export$314a718b3c247043 =
  'focus:ud-outline-none focus:ud-ring-1 focus:ud-ring-offset-0 focus:ud-ring-primary';

const $2480fd5c982ae396$var$Input = /*#__PURE__*/ $fbsOk$react.forwardRef(
  ({ label: label, error: error, className: className, ...rest }, ref) => {
    return /*#__PURE__*/ $fbsOk$reactjsxruntime.jsxs('div', {
      ...
      children: [
        /*#__PURE__*/ $fbsOk$reactjsxruntime.jsx('label', {
          htmlFor: label,
          className:
            'ud-capitalize ud-font-semibold ud-mb-1 ud-text-gray-600 ud-text-sm',
          __source: {
            fileName: 'Dev/ud-miniapp-components/src/components/Input.js',
            lineNumber: 10,
            columnNumber: 7,
...
function $a259075f1cf3825a$var$ContentCardList({
  title: title,
  items: items,
  ...
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('div', {
    className: $parcel$interopDefault($81XA9$classnames)(
      'ud-flex ud-flex-col ud-space-y-2',
      {
    ...
    children: [
      /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('div', {
        ...
        children: [
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
            $8026b5d0dd95d057$export$2e2bcd8739ae039,
            {
              __source: {
                fileName: 'src/components/ContentCardList.js',
                lineNumber: 24,
          ...
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
            $3415cc989545fa06$export$2e2bcd8739ae039,
            {
              variant: 'link',
              className: $parcel$interopDefault($81XA9$classnames)({
                'ud-mr-6': hasPadding,
        ...
        children: items.map((item, index) =>
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
            'div',
            {
              ...
              __self: this,
              children: /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
                $6844af41886a83f1$export$2e2bcd8739ae039,
                {
...
var $a259075f1cf3825a$export$2e2bcd8739ae039 =
  $a259075f1cf3825a$var$ContentCardList;

function $caf936a2347067ba$var$LoanCard({
  firstName: firstName,
  avatarUrl: avatarUrl,
  amount: amount,
      ...
      /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('div', {
        ...
        children: [
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsxs('p', {
            ...
            __self: this,
            children: [firstName, ' Personal loan'],
          }),
          /*#__PURE__*/ $81XA9$reactjsxruntime.jsx(
            $1dfa65d911dbcc46$export$2e2bcd8739ae039,
            {
...
function $7ae3f157f890d136$var$Subtitle({ children: children }) {
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('h3', {
...
$7ae3f157f890d136$var$Subtitle.propTypes = {
  children: $parcel$interopDefault($81XA9$proptypes).oneOfType([
    $parcel$interopDefault($81XA9$proptypes).string,
  ]).isRequired,
};
var $7ae3f157f890d136$export$2e2bcd8739ae039 = $7ae3f157f890d136$var$Subtitle;
...
function $2ff28e8b883a699f$var$VSpace({ size: size = 'extraLarge' }) {
  return /*#__PURE__*/ $81XA9$reactjsxruntime.jsx('div', {
    className: $parcel$interopDefault($81XA9$classnames)(
      $2ff28e8b883a699f$var$SPACE_SIZE[size]
    ),
    __source: {
